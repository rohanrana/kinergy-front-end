...
const employeeApis = {
  ...
  edit: (req, res, next) => {
    if (!req.body._id) {
      ...
      Employee.findOneAndUpdate({ _id: req.body._id }, editData, { new: true })
        .lean()
        .exec((err, result) => {
          if (!err) {
            if (
              (req.body.oldSsnDocument !== "undefined" ||
                req.body.oldSsnDocument !== null) &&
              (req.body.ssnDocument !== "undefined" ||
                req.body.sSsnDocument !== null)
            ) {
              let filePath =
                "public/uploads/employee/" + "/" + req.body.oldSsnDocument;
              fs.unlink(filePath, function (err) {
                if (!err) console.log("removed");
              });
            }
            if (
              req.body.oldDriverLicense !== "undefined" &&
              req.body.oldDriverLicense !== null &&
              req.body.driverLicense !== "undefined" &&
              req.body.driverLicense !== null
            ) {
              let filePath =
                "public/uploads/employee/" + "/" + req.body.oldDriverLicense;
              fs.unlink(filePath, function (err) {
                if (!err) console.log("removed");
              });
            }
            if (
              req.body.oldWorkPermit !== "undefined" &&
              req.body.oldWorkPermit !== null &&
              req.body.workPermit !== "undefined" &&
              req.body.workPermit !== null
            ) {
              let filePath =
                "public/uploads/employee/" + "/" + req.body.oldWorkPermit;
              fs.unlink(filePath, function (err) {
                if (!err) console.log("removed");
              });
            }
  ...
  fileUpload: (req, res, next) => {
    var fileLocation = "public/uploads/employee";
