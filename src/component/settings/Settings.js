          ...
          <Col lg={12} sm={12} xs={12}>
                ...
                <Col lg={12} sm={12} xs={12}>
                  <div className="setting-top">
                    ...
                    <div className="setting-top-button">
                      <a href="#/edit-personal-detail" className="btn btn-theme">
            ...
            <div className="appointment-card">
              <h6 className="mb-5">
                ...
                <span className="float-right">
                  <a href="#/edit-contact-information" className="btn btn-theme">
                    <i className="fas fa-pencil mr-2"></i>Edit Details
                  </a>
                </span>
              </h6>
            ...
            <div className="appointment-card">
              <h6 className="mb-5">
                Update Password{" "}
                <span className="float-right">
                  <a href="#/update-password" className="btn btn-theme">Update Password</a>
                </span>
              </h6>
              <p>
