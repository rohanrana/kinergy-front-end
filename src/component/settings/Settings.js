      ...
      <Container fluid>
        <Row>
          ...
          <Col lg={12} sm={12} xs={12}>
                    ...
                    <Col lg={12} sm={12} xs={12}>
                        <div className="setting-top">
                            ...
                            <div className="setting-top-button">
                                <Button className="btn btn-theme"><i className="fas fa-pencil mr-2"></i>Edit Details</Button>
                            </div>
                        </div>
                    </Col>
                </Row>
            ...
            <div className="appointment-card">
                <h6 className="mb-5">Contact Information <span className="float-right"><Button className="btn btn-theme"><i className="fas fa-pencil mr-2"></i>Edit Details</Button></span></h6>
...
Las Vegas, NV 89123
            ...
            <div className="appointment-card">
                <h6 className="mb-5">Update Password <span className="float-right"><Button className="btn btn-theme">Update Password</Button></span></h6>
            ...
            <div className="appointment-card">
                <h6 className="mb-5">Other Preferences <span className="float-right"><Button className="btn btn-theme"><i className="fas fa-pencil mr-2"></i>Edit Details</Button></span></h6>
                ...
                <h6 className="mb-5">Two-factor Authentication <span className="float-right"><Button className="btn btn-theme">Enable</Button></span></h6>
                ...
                <Row>
                    ...
                    <Col lg={4} sm={4} xs={12} className="text-right">
                        <Button className="btn btn-theme-white btn-setting-add">Add Email</Button>
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col lg={4} sm={4} xs={12} className="text-right">
                        <Button className="btn btn-theme-white btn-setting-add">Add phone number</Button>
                    </Col>
                </Row>
