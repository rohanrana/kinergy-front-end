        ...
        <Row>
          <Col lg={12} sm={12} xs={12}>
            <div className="appointment-card">
              ...
              >
                ...
                <ButtonGroup className="rounded">
                  ...
                  <DropdownButton className="p-0 rounded-0" title="">
                    <Dropdown.Item eventKey="1">Transfer File</Dropdown.Item>
                    <Dropdown.Item eventKey="2">Inport This Note</Dropdown.Item>
                  </DropdownButton>
                </ButtonGroup>
              </ButtonToolbar>
              <p>
              ...
              >
                <ButtonGroup className="rounded">
                  <Button className="btn btn-theme-white">Print Notes</Button>
