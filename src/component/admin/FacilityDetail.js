        ...
        <Row>
          ...
          <Col lg={9} sm={8} xs={12}>
              <p className="text-right mt-3">
                  <a href="#/edit-facility" className="btn btn-theme"><i className="fas fa-pencil mr-2"></i>Edit Details</a>
              </p>
          <div className="appointment-card mt-0">
              <p className="text-right"><i class="fas fa-circle"></i> Active</p>
