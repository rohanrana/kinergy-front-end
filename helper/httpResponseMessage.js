module.exports = {
  ...
  STATE_ID_NOT_FOUND: "Please enter state id.",
  // State
  ...
  // Access Level
  ACCESS_LEVEL_ADD_SUCCESSFULLY:"Level add successfully.",
  LEVEL_PERMISSION_ADD_SUCCESSFULLY:"Level Permission Add Successfully",
};
